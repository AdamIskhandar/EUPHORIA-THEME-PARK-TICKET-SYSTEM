...
public class Receipt extends javax.swing.JFrame {
    ...
    public Receipt(TicketInformation ticketInfo, CustomerInformation customerInfo) {
        this.ticketInfo = ticketInfo;
        this.customerInfo = customerInfo;
        initComponents(ticketInfo, customerInfo);
    }

    private void initComponents(TicketInformation ticketInfo, CustomerInformation customerInfo) {
        ...
        jLabel2.setText("THEME PARK SDN.BHD ");

        jLabel3.setText("JALAN 1, SUNWAY");

        jLabel4.setText("KUALA LUMPUR");

        jLabel5.setText("-----------------------------------------------------------------------------------");

        jLabel6.setText("EUPHORIA THEME PARK");

        jLabel7.setText("-----------------------------------------------------------------------------------");

        jLabel8.setText("Ticket ID           :");

        jLabel9.setText(ticketInfo.getTicketId());

        jLabel10.setText("Custmer Name :");

        jLabel11.setText(customerInfo.getCustName());

        jLabel12.setText("Customer ID     :");

        jLabel13.setText(customerInfo.getCustId());

        jLabel14.setText("Counter Paid    :");

        jLabel15.setText(Integer.toString(customerInfo.getCounterPaid()));

        jLabel16.setText("  Qty");

        jLabel17.setText("Item");

        jLabel18.setText(Integer.toString(customerInfo.getTicketsQuantity()));

        jLabel19.setText(ticketInfo.getRideName());

        jLabel20.setText("Total ( RM )");

        jLabel21.setText(Double.toString(ticketInfo.getTicketPrice()));

        jLabel22.setText("Total ( RM )");

        jLabel23.setText(Double.toString(customerInfo.getTotalPay()));

        jLabel24.setText("---------------------------------------------------------------------------------");

        jLabel25.setText("Thank for purchase!! give us your feedback!");
